    ...
    public:
        ...
        static AudioProcessorValueTreeState::ParameterLayout createParameterLayout()
        {
            return AudioProcessorValueTreeState::ParameterLayout{
                ...
                std::make_unique<AudioParameterInt>(juce::ParameterID("ex len", 1), "Excitation Length", NormalisableRange<float>{0.001f, 1.f, 0.001f}, 1.f),
                ...
                std::make_unique<AudioParameterBool>(juce::ParameterID("match in rms", 1), "Match Input RMS Level", true)
            };
        }
    };
}
